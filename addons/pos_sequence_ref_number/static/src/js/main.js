        ...
        module.PosModel = module.PosModel.extend({
            load_server_data: function () {
                ...
                self.models.push({
                    ...
                    loaded: function (self, sequence) {
                        self.pos_order_sequence = sequence[0];
                    },
                });
            ...
            push_order: function(order) {
                if (order !== undefined) {
                    ...
                    var sequence_obj_returned = module.PaymentScreenWidget.prototype.get_correct_sequence();
                    console.log(sequence_obj_returned,"sequence_obj_returned")
                    order.set({'sequence_ref_number': sequence_obj_returned.number_next_actual});
                    order.set({'sequence_ref': _sequence_next(sequence_obj_returned)});
                }
