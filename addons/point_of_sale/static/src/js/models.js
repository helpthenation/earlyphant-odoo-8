function openerp_pos_models(instance, module){ //module is instance.point_of_sale
    ...
    module.Order = Backbone.Model.extend({
        ...
        // adding new
        set_table_number: function(table_number){
            this.number=table_number;
        },
        get_table_number: function(){
            return this.number;
        },
        set_number_customer: function(number_customer){
            this.number_customer = number_customer;
        },
        get_number_customer: function(){
            return this.number_customer;
        },
        get_receipt_ref: function(){
            console.log(this.get('sequence_ref'))
            return this.get('sequence_ref');
        },
        // end adding
        ...
        export_as_JSON: function() {
            ...
            return {
                ...
                //adding new
                name : this.get_receipt_ref(),
                number_of_customer: this.get_number_customer(),
                //end adding
