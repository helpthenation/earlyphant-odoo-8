...
function openerp_pos_screens(instance, module){ //module is instance.point_of_sale
    ...
    module.PaymentScreenWidget = module.ScreenWidget.extend({
        ...
        get_correct_sequence: function () {
            console.log(sequence_obj, "get_correct_sequence");
            return sequence_obj;
        },
        set_correct_sequence: function (obj) {
            sequence_obj = obj;
            console.log(sequence_obj, "set_correct_sequence")
        },
        validate_order: function (options) {
            var self = this;
            var Users = new openerp.Model('ir.sequence');
            var sequence_id = self.pos.get('selectedOrder').attributes.pos.config.sequence_id[0];
            options = options || {};

            console.log(sequence_id,"validate_order");
            ...
            Users
                ...
                .then(function (obj) {
                    ...
                    // var lili = module.PosModel.prototype.load_new_sequence();
                    self.set_correct_sequence(obj);
        ...
        //                 receipt: receipt, widget: self, order:this.pos.get('selectedOrder'),
        //             }));
        //             setTimeout(function(){
        //                 self.pos.proxy.print_receipt(QWeb.render('XmlReceipt',{
        //                     receipt: receipt, widget: self,order:self.pos.get('selectedOrder')
