...
class pos_order(osv.osv):
    ...
    def _order_fields(self, cr, uid, ui_order, context=None):
        return {
            ...
            'number_of_customer':ui_order['number_of_customer'],
        }
    ...
    _columns = {
        'name': fields.char('Order Ref', required=True, readonly=False, copy=False),
        ...
        'pos_reference': fields.char('Receipt Ref', readonly=False, copy=False),
