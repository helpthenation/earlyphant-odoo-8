...
class stock_picking(osv.osv):
    ...
    _defaults = {
        ...
        # 'source_loc':_default_location_source,
        # 'destination_loc':_default_location_destination,
    }
    _sql_constraints = [
    ...
    def write(self, cr, uid, ids, vals, context=None):
        #pisey added
        # if 'create_from_POS' in vals:
        #     del vals['create_from_POS']
        ############
        ...
        # if (picking_ids.source_loc.id or picking_ids.destination_loc.id) and picking_ids.state =='draft':
        #     for move in picking_ids.move_lines:
        #         move.write({'location_id':picking_ids.source_loc.id,
        #                     'location_dest_id':picking_ids.destination_loc.id,})
        # if 'project_id' in vals:
        #     for move in picking_ids.move_lines:
        #         move.write({'project_id':picking_ids.project_id.id})
        ############
        return res
...
class stock_move(osv.osv):
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        # #pisey added
        # if vals.get('picking_id') and not vals.get('create_from_POS') and not vals.get('create_from_PO') and not vals.get('split_from'):
        #     picking_ids = picking_obj.browse(cr,uid,vals['picking_id'],context=context)
        #     vals['location_id'] = picking_ids.source_loc.id
        #     vals['location_dest_id'] = picking_ids.destination_loc.id
        #     vals['project_id'] = picking_ids.project_id.id
        # if 'create_from_POS' in vals:
        #     del vals['create_from_POS']
        # if 'create_from_PO' in vals:
        #     del vals['create_from_PO']
        # ############
